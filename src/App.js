...
function App() {
  ...
  var url = `https://api.edamam.com/search?q=${inputValue}&app_id=45918ea0&app_key=%203a2b8ca91fd63b1240eaffc66c36f0a0&from=0&to=20&calories=591-722&health=${healthLables}`;
